...
func TestNoAllocs(t *testing.T) {
	...
	test("AddrFrom4", func() { sinkIP = AddrFrom4([4]byte{
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	}1, 2, 3, 4}) })
	...
	test("ParseAddr/4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = panicIP(ParseAddr("1.2.3.4")) })
	test("ParseAddr/6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = panicIP(ParseAddr("::1")) })
	test("MustParseAddr", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = MustParseAddr("1.2.3.4") })
	test("IPv6LinkLocalAllNodes", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = IPv6LinkLocalAllNodes() })
	test("IPv6Unspecified", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	...
	test("IP.IsZero", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("1.2.3.4").IsZero() })
	test("IP.BitLen", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("1.2.3.4").BitLen() == 8 })
	test("IP.Zone/4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("1.2.3.4").Zone() == "" })
	test("IP.Zone/6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").Zone() == "" })
	test("IP.Zone/6zone", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1%zone").Zone() == "" })
	...
	test("IP.Is4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("1.2.3.4").Is4() })
	test("IP.Is6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").Is6() })
	test("IP.Is4In6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").Is4In6() })
	test("IP.Unmap", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = MustParseAddr("ffff::2.3.4.5").Unmap() })
	test("IP.WithZone", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = MustParseAddr("fe80::1").WithZone("") })
	test("IP.IsGlobalUnicast", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("2001:db8::1").IsGlobalUnicast() })
	test("IP.IsInterfaceLocalMulticast", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").IsInterfaceLocalMulticast() })
	test("IP.IsLinkLocalMulticast", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").IsLinkLocalMulticast() })
	test("IP.IsLinkLocalUnicast", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").IsLinkLocalUnicast() })
	test("IP.IsLoopback", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").IsLoopback() })
	test("IP.IsMulticast", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fe80::1").IsMulticast() })
	test("IP.IsPrivate", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParseAddr("fd00::1").IsPrivate() })
	test("IP.IsUnspecified", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = IPv6Unspecified().IsUnspecified() })
	test("IP.Prefix/4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = panicPfx(MustParseAddr("1.2.3.4").Prefix(20)) })
	test("IP.Prefix/6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = panicPfx(MustParseAddr("fe80::1").Prefix(64)) })
	test("IP.As16", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP16 = MustParseAddr("1.2.3.4").As16() })
	test("IP.As4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP4 = MustParseAddr("1.2.3.4").As4() })
	test("IP.Next", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = MustParseAddr("1.2.3.4").Next() })
	test("IP.Prev", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkIP = MustParseAddr("1.2.3.4").Prev() })

	// AddrPort constructors
	test("AddrPortFrom", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkAddrPort = AddrPortFrom(IPv4(1, 2, 3, 4), 22) })
	test("ParseAddrPort", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkAddrPort = panicIPP(ParseAddrPort("[::1]:1234")) })
	test("MustParseAddrPort", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkAddrPort = MustParseAddrPort("[::1]:1234") })

	// Prefix constructors
	test("PrefixFrom", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = PrefixFrom(IPv4(1, 2, 3, 4), 32) })
	test("ParsePrefix/4", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = panicPfx(ParsePrefix("1.2.3.4/20")) })
	test("ParsePrefix/6", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = panicPfx(ParsePrefix("fe80::1/64")) })
	test("MustParsePrefix", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = MustParsePrefix("1.2.3.4/20") })

	// Prefix methods
	test("Prefix.Contains", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParsePrefix("1.2.3.0/24").Contains(MustParseAddr("1.2.3.4")) })
	...
	test("Prefix.IsZero", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParsePrefix("1.2.0.0/16").IsZero() })
	test("Prefix.IsSingleIP", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkBool = MustParsePrefix("1.2.3.4/32").IsSingleIP() })
	test("IPPRefix.Masked", func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} sinkPrefix = MustParsePrefix("1.2.3.4/16").Masked() })
}
