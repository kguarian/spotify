...
func (sr slurpResult) String() string {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return fmt.Sprintf("body %q; err %v", sr.body, sr.err) }
...
func TestH2_304NoBody(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testH12_noBody(t, 304) }
func TestH2_404NoBody(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testH12_noBody(t, 404) }
...
func Test304Responses_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} test304Responses(t, h1Mode) }
func Test304Responses_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} test304Responses(t, h2Mode) }
...
func TestH12_RequestContentLength_Known_NonZero(t *testing.T) {
	...
	h12requestContentLength(t, func() io.Reader {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return strings.NewReader("FOUR") }, 4)
}
...
func TestH12_RequestContentLength_Unknown(t *testing.T) {
	...
	h12requestContentLength(t, func() io.Reader { return struct{ io.Reader }{
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	}strings.NewReader("Stuff")} }, -1)
}
...
func TestCancelRequestMidBody_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCancelRequestMidBody(t, h1Mode) }
func TestCancelRequestMidBody_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCancelRequestMidBody(t, h2Mode) }
...
func TestTrailersClientToServer_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTrailersClientToServer(t, h1Mode) }
...
func TestTrailersServerToClient_h1(t *testing.T)       {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTrailersServerToClient(t, h1Mode, false) }
...
func TestTrailersServerToClient_Flush_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTrailersServerToClient(t, h1Mode, true) }
...
func TestResponseBodyReadAfterClose_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testResponseBodyReadAfterClose(t, h1Mode) }
func TestResponseBodyReadAfterClose_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testResponseBodyReadAfterClose(t, h2Mode) }
...
func TestConcurrentReadWriteReqBody_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testConcurrentReadWriteReqBody(t, h1Mode) }
...
func TestConnectRequest_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testConnectRequest(t, h1Mode) }
func TestConnectRequest_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testConnectRequest(t, h2Mode) }
...
func TestTransportUserAgent_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportUserAgent(t, h1Mode) }
func TestTransportUserAgent_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportUserAgent(t, h2Mode) }
func testTransportUserAgent(t *testing.T, h2 bool) {
			...
			func(r *Request) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} r.Header.Set("User-Agent", "foo/1.2.3") },
			`["foo/1.2.3"]`,
		},
		{
			func(r *Request) { r.Header["User-Agent"] = []string{
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	}"single", "or", "multiple"} },
...
func TestTransportDiscardsUnneededConns(t *testing.T) {
		...
		DialTLS: func(_, addr string) (net.Conn, error) {
	{
		...
		defer mytrace.LogExit()
			...
			c := noteCloseConn{rc, func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} atomic.AddInt32(&numClose, 1) }}
...
func TestTransportGCRequest_Body_h1(t *testing.T)   {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportGCRequest(t, h1Mode, true) }
func TestTransportGCRequest_Body_h2(t *testing.T)   {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportGCRequest(t, h2Mode, true) }
func TestTransportGCRequest_NoBody_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportGCRequest(t, h1Mode, false) }
func TestTransportGCRequest_NoBody_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportGCRequest(t, h2Mode, false) }
func testTransportGCRequest(t *testing.T, h2, body bool) {
	...
	(func() {
	{
		...
		runtime.SetFinalizer(req, func(*Request) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} close(didGC) })
...
func TestInterruptWithPanic_h1(t *testing.T)     {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testInterruptWithPanic(t, h1Mode, "boom") }
func TestInterruptWithPanic_h2(t *testing.T)     {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testInterruptWithPanic(t, h2Mode, "boom") }
...
func TestCloseIdleConnections_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCloseIdleConnections(t, h1Mode) }
func TestCloseIdleConnections_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCloseIdleConnections(t, h2Mode) }
...
func TestNoSniffExpectRequestBody_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testNoSniffExpectRequestBody(t, h1Mode) }
...
func TestServerUndeclaredTrailers_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerUndeclaredTrailers(t, h1Mode) }
func TestServerUndeclaredTrailers_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerUndeclaredTrailers(t, h2Mode) }
...
func TestWriteHeader0_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testWriteHeader0(t, h1Mode) }
func TestWriteHeader0_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testWriteHeader0(t, h2Mode) }
...
func TestWriteHeaderNoCodeCheck_h1(t *testing.T)       {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testWriteHeaderAfterWrite(t, h1Mode, false) }
func TestWriteHeaderNoCodeCheck_h1hijack(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testWriteHeaderAfterWrite(t, h1Mode, true) }
func TestWriteHeaderNoCodeCheck_h2(t *testing.T)       {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testWriteHeaderAfterWrite(t, h2Mode, false) }
...
func TestIdentityTransferEncoding_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testIdentityTransferEncoding(t, h1Mode) }
func TestIdentityTransferEncoding_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testIdentityTransferEncoding(t, h2Mode) }
