...
func TestServer(t *testing.T) {
			...
			t.Run("Server", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServer(t, newServer) })
			t.Run("GetAfterClose", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testGetAfterClose(t, newServer) })
			t.Run("ServerCloseBlocking", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerCloseBlocking(t, newServer) })
			t.Run("ServerCloseClientConnections", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerCloseClientConnections(t, newServer) })
			t.Run("ServerClientTransportType", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerClientTransportType(t, newServer) })
		})
	}
		...
		t.Run(name, func(t *testing.T) {
	{
		...
		defer mytrace.LogExit()
			...
			newServer := newServers[name]
			t.Run("ServerClient", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerClient(t, newServer) })
			t.Run("TLSServerClientTransportType", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTLSServerClientTransportType(t, newServer) })
		})
	}
}
