...
func TestClientHead_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientHead(t, h1Mode) }
func TestClientHead_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientHead(t, h2Mode) }
...
func TestStreamingGet_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testStreamingGet(t, h1Mode) }
func TestStreamingGet_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testStreamingGet(t, h2Mode) }
...
func TestClientTimeout_Headers_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientTimeout_Headers(t, h1Mode) }
...
func TestClientTimeoutDoesNotExpire_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientTimeoutDoesNotExpire(t, h1Mode) }
func TestClientTimeoutDoesNotExpire_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientTimeoutDoesNotExpire(t, h2Mode) }
...
func TestClientRedirectEatsBody_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientRedirectEatsBody(t, h1Mode) }
func TestClientRedirectEatsBody_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testClientRedirectEatsBody(t, h2Mode) }
