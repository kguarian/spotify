...
func TestServeFileWithContentEncoding_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServeFileWithContentEncoding(t, h1Mode) }
func TestServeFileWithContentEncoding_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServeFileWithContentEncoding(t, h2Mode) }
...
func (issue12991FS) Open(string) (File, error) { return issue12991File{
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	}}, nil }
...
func TestFileServerNotDirError(t *testing.T) {
	...
	t.Run("Dir", func(t *testing.T) {
	{
		...
		testFileServerNotDirError(t, func(path string) FileSystem {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return Dir(path) })
