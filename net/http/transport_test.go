...
func TestTransportHeadChunkedResponse(t *testing.T) {
	...
	SetReadLoopBeforeNextReadHook(func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} didRead <- true })
...
func TestTransportReading100Continue(t *testing.T) {
	...
	const numReqs = 5
	reqBody := func(n int) string {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return fmt.Sprintf("request body %d", n) }
	reqID := func(n int) string {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return fmt.Sprintf("REQ-ID-%d", n) }
...
func TestTransportEventTrace(t *testing.T)    {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportEventTrace(t, h1Mode, false) }
func TestTransportEventTrace_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportEventTrace(t, h2Mode, false) }
...
func TestTransportEventTrace_NoHooks(t *testing.T)    {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportEventTrace(t, h1Mode, true) }
func TestTransportEventTrace_NoHooks_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportEventTrace(t, h2Mode, true) }
...
func testTransportEventTrace(t *testing.T, h2 bool, noHooks bool) {
		...
		GetConn:              func(hostPort string) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} logf("Getting conn for %v ...", hostPort) },
		...
		DNSStart:             func(e httptrace.DNSStartInfo) {
	{
		...
		DNSDone:              func(e httptrace.DNSDoneInfo) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} logf("DNS done: %+v", e) },
		ConnectStart:         func(network, addr string) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} logf("ConnectStart: Connecting to %s %s ...", network, addr) },
...
func TestTransportEventTraceRealDNS(t *testing.T) {
		...
		ConnectStart: func(network, addr string) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} logf("ConnectStart: %s %s", network, addr) },
		ConnectDone:  func(network, addr string, err error) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} logf("ConnectDone: %s %s %v", network, addr, err) },
	}
	req = req.WithContext(httptrace.WithClientTrace(context.Background(), trace))
...
func TestTransportIdleConnTimeout_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportIdleConnTimeout(t, h1Mode) }
func TestTransportIdleConnTimeout_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportIdleConnTimeout(t, h2Mode) }
...
func TestTransportIDNA_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportIDNA(t, h1Mode) }
func TestTransportIDNA_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTransportIDNA(t, h2Mode) }
...
func TestTransportRequestWriteRoundTrip(t *testing.T) {
	...
	newBufferfunc := func() (io.Reader, func(), error) {
	{
		...
		return bytes.NewBuffer(make([]byte, nBytes)), func() {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	}}, nil
...
func TestTransportClone(t *testing.T) {
		...
		DialTLSContext:         func(ctx context.Context, network, addr string) (net.Conn, error) {
	{
		...
		GetProxyConnectHeader:  func(context.Context, *url.URL, string) (Header, error) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} return nil, nil },
