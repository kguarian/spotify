...
func BenchmarkServeMux(b *testing.B)           {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} benchmarkServeMux(b, true) }
func BenchmarkServeMux_SkipServe(b *testing.B) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} benchmarkServeMux(b, false) }
...
func TestSetsRemoteAddr_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSetsRemoteAddr(t, h1Mode) }
func TestSetsRemoteAddr_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSetsRemoteAddr(t, h2Mode) }
...
func TestHeadResponses_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHeadResponses(t, h1Mode) }
func TestHeadResponses_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHeadResponses(t, h2Mode) }
...
func TestTimeoutHandler_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTimeoutHandler(t, h1Mode) }
func TestTimeoutHandler_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testTimeoutHandler(t, h2Mode) }
...
func TestHandlerPanicNil_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHandlerPanic(t, false, h1Mode, nil, nil) }
func TestHandlerPanicNil_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHandlerPanic(t, false, h2Mode, nil, nil) }
...
func TestServerNoDate_h1(t *testing.T)        {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerNoHeader(t, h1Mode, "Date") }
func TestServerNoDate_h2(t *testing.T)        {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerNoHeader(t, h2Mode, "Date") }
func TestServerNoContentType_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerNoHeader(t, h1Mode, "Content-Type") }
func TestServerNoContentType_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerNoHeader(t, h2Mode, "Content-Type") }
...
func TestRequestLimit_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testRequestLimit(t, h1Mode) }
func TestRequestLimit_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testRequestLimit(t, h2Mode) }
...
func TestRequestBodyLimit_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testRequestBodyLimit(t, h1Mode) }
func TestRequestBodyLimit_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testRequestBodyLimit(t, h2Mode) }
...
func TestCaseSensitiveMethod_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCaseSensitiveMethod(t, h1Mode) }
func TestCaseSensitiveMethod_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testCaseSensitiveMethod(t, h2Mode) }
...
func TestServerReaderFromOrder_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerReaderFromOrder(t, h1Mode) }
func TestServerReaderFromOrder_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerReaderFromOrder(t, h2Mode) }
...
func TestServerEmptyBodyRace_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerEmptyBodyRace(t, h1Mode) }
func TestServerEmptyBodyRace_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerEmptyBodyRace(t, h2Mode) }
...
func TestHandlerSetsBodyNil_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHandlerSetsBodyNil(t, h1Mode) }
func TestHandlerSetsBodyNil_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testHandlerSetsBodyNil(t, h2Mode) }
...
func TestServerKeepAlivesEnabled_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerKeepAlivesEnabled(t, h1Mode) }
func TestServerKeepAlivesEnabled_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerKeepAlivesEnabled(t, h2Mode) }
