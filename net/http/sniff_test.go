...
func TestServerContentType_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerContentType(t, h1Mode) }
func TestServerContentType_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerContentType(t, h2Mode) }
...
func TestServerIssue5953_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerIssue5953(t, h1Mode) }
func TestServerIssue5953_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testServerIssue5953(t, h2Mode) }
...
func TestContentTypeWithVariousSources_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testContentTypeWithVariousSources(t, h1Mode) }
func TestContentTypeWithVariousSources_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testContentTypeWithVariousSources(t, h2Mode) }
...
func TestSniffWriteSize_h1(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSniffWriteSize(t, h1Mode) }
func TestSniffWriteSize_h2(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSniffWriteSize(t, h2Mode) }
