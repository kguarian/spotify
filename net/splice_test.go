...
func TestSplice(t *testing.T) {
	...
	t.Run("tcp-to-tcp", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSplice(t, "tcp", "tcp") })
...
func testSplice(t *testing.T, upNet, downNet string) {
	...
	t.Run("readerAtEOF", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSpliceReaderAtEOF(t, upNet, downNet) })
	t.Run("issue25985", func(t *testing.T) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} testSpliceIssue25985(t, upNet, downNet) })
}
...
func BenchmarkSplice(b *testing.B) {
	...
	b.Run("tcp-to-tcp", func(b *testing.B) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} benchSplice(b, "tcp", "tcp") })
	b.Run("unix-to-tcp", func(b *testing.B) {
	{
		mytrace.LogEnter()
		defer mytrace.LogExit()
	} benchSplice(b, "unix", "tcp") })
}
