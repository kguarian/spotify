...
import {UrlServer, UrlTrackQueryParams, UrlTools} from './api_consts'
...
export class SearchAppBar extends Component {
  ...
  async fetchData(query) {
    const url = UrlServer + UrlTools + UrlTrackQueryParams + query;
      ...
      if (resp.ok) {
        resp.json().then(jsonData => {
          if (jsonData) {
            ...
            this.setState({ searchResults: jsonData, numSearchResults: jsonData.length, loading: false })
          }
        });
      }
    });
